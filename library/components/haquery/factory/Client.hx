...
class Client extends BaseClient
{
	...
	{
		var n = length;
		var r = Lib.manager.createComponent(this, "components.haquery.factoryitem", Std.string(n), true, { parentElem:parentElem, html:page.storage.getInstanceVar(this, "html"), params:params, append:append } );
