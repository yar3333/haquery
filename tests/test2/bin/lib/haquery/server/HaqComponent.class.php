...
class haquery_server_HaqComponent extends haquery_base_HaqComponent {
	...
	public function createChildComponents_inner($baseNode) {
		...
		while($i < count($baseNode->children)) {
			...
			haquery_base_HaQuery::assert($node->name !== "haq:placeholder", null, _hx_anonymous(array("fileName" => "HaqComponent.hx", "lineNumber" => 87, "className" => "haquery.server.HaqComponent", "methodName" => "createChildComponents_inner")));
			haquery_base_HaQuery::assert($node->name !== "haq:content", null, _hx_anonymous(array("fileName" => "HaqComponent.hx", "lineNumber" => 88, "className" => "haquery.server.HaqComponent", "methodName" => "createChildComponents_inner")));
	...
	public function render() {
		...
		if(haquery_base_HaQuery::$config->isTraceComponent) {
			haxe_Log::trace("render " . $this->fullID, _hx_anonymous(array("fileName" => "HaqComponent.hx", "lineNumber" => 155, "className" => "haquery.server.HaqComponent", "methodName" => "render")));
		}
