...
class OrmModelGenerator 
{
	...
	static function getAutoGeneratedModel(table:String, vars:List<OrmHaxeVar>, fullClassName:String, baseFullClassName:String=null) : OrmHaxeClassGenerator
	{
	...
	static function getCustomModel(table:String, vars:List<OrmHaxeVar>, fullClassName:String, baseFullClassName:String=null) : OrmHaxeClassGenerator
	{
		var model:OrmHaxeClassGenerator = new OrmHaxeClassGenerator(fullClassName, baseFullClassName);
