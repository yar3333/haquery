// d:\MyProg\HaQueryLib\library
#if php
import haquery.components.alternative.Server;
import haquery.components.button.Server;
import haquery.components.checkbox.Server;
import haquery.components.ckeditor.Server;
import haquery.components.container.Server;
import haquery.components.context.Server;
import haquery.components.helper.Server;
import haquery.components.link.Server;
import haquery.components.list.Server;
import haquery.components.listitem.Server;
import haquery.components.literal.Server;
import haquery.components.radioboxes.Server;
import haquery.components.shadow.Server;
...
import haquery.components.waiter.Server;
#else
import haquery.components.alternative.Client;
import haquery.components.button.Client;
import haquery.components.checkbox.Client;
import haquery.components.ckeditor.Client;
import haquery.components.container.Client;
import haquery.components.context.Client;
import haquery.components.helper.Client;
import haquery.components.link.Client;
import haquery.components.list.Client;
import haquery.components.listitem.Client;
import haquery.components.radioboxes.Client;
import haquery.components.shadow.Client;
...
import haquery.components.waiter.Client;
#end
