...
class Reflect {
	...
	static function hasMethod($o, $field) {
		$GLOBALS['%s']->push("Reflect::hasMethod");
		$»spos = $GLOBALS['%s']->length;
		{
			$»tmp = _hx_has_field($o, $field) && Reflect::isFunction(Reflect::field($o, $field));
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
	}
	static function publicVars($o) {
		$GLOBALS['%s']->push("Reflect::publicVars");
		$»spos = $GLOBALS['%s']->length;
		$publicFieldsAsPhpArray = null;
		$getFields = create_function('$obj', 'return array_keys(get_object_vars($obj));');
		$publicFieldsAsPhpArray = $getFields($o);
		{
			$»tmp = new _hx_array($publicFieldsAsPhpArray);
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
	}
	static function isInstanceOf($o, $className) {
		$GLOBALS['%s']->push("Reflect::isInstanceOf");
		$»spos = $GLOBALS['%s']->length;
		$className = str_replace(".", "_", $className);
		{
			$»tmp = $o instanceof $className;
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
