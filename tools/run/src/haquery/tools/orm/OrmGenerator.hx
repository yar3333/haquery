...
class OrmGenerator
{
	...
	function new(db:HaqDb, log:Log, project:FlashDevelopProject)
    {
        ...
        for (table in db.connection.getTables())
        {
			...
			OrmModelGenerator.make(db, log, table, basePath, 'models.server.' + className, 'models.server.autogenerated.' + className, 'managers.server.' + className + 'Manager', project);
			OrmManagerGenerator.make(db, log, table, basePath, 'models.server.' + className, 'managers.server.' + className + 'Manager', 'managers.server.autogenerated.' + className + 'Manager', project);
        }
    }
