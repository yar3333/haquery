...
{
	static public function make(log:Log, table:String, basePath:String, modelFullClassName:String, customManagerFullClassName:String, autoGenManagerFullClassName:String) : Void
	{
	...
	static function getAutoGeneratedManager(table:String, vars:List<HaxeVar>, modelFullClassName:String, fullClassName:String, baseFullClassName:String=null) : HaxeClass
	{
    ...
    static function getForeignKeyVars(table:String, vars:List<HaxeVar>) : List<HaxeVar>
    {
        var foreignKeys = HaqDb.connection.getForeignKeys(table);
