...
{
	static public function make(db:HaqDb, log:Log, table:String, basePath:String, customModelFullClassName:String, autoGenModelFullClassName:String, customManagerFullClassName:String) : Void
	{
		...
		{
			File.saveContent(pathToCustomModel, customModel.toString());
		}
