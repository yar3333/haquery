...
class OrmGenerator
{
	...
	public function generate(db:HaqDb)
	{
		for (table in db.connection.getTables())
        {
			...
			OrmModelGenerator.make(log, project, db, table, 'models.server.' + className, 'models.server.autogenerated.' + className, 'models.server.' + className + 'Manager');
			OrmManagerGenerator.make(log, project, db, table, 'models.server.' + className, 'models.server.' + className + 'Manager', 'models.server.autogenerated.' + className + 'Manager');
        }
    }
