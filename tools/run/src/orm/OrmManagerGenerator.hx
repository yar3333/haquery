...
{
	public static function make(log:Log, project:FlashDevelopProject, db:HaqDb, table:String, modelFullClassName:String, customManagerFullClassName:String, autoGenManagerFullClassName:String) : Void
	{
		...
		var destFileName = basePath + autoGenManagerFullClassName.replace('.', '/') + '.hx';
		...
		if (project.findFile(customManagerFullClassName.replace('.', '/') + '.hx') == null)
		{
			...
			var destFileName = basePath + customManagerFullClassName.replace('.', '/') + '.hx';
			FileSystem.createDirectory(Path.directory(destFileName));
	...
	static function getAutoGeneratedManager(db:HaqDb, table:String, vars:List<OrmHaxeVar>, modelFullClassName:String, fullClassName:String, baseFullClassName:String=null) : HaxeClass
	{
	...
	static function getCustomManager(table:String, vars:List<OrmHaxeVar>, modelFullClassName:String, fullClassName:String, baseFullClassName:String=null) : HaxeClass
	{
		var model:HaxeClass = new HaxeClass(fullClassName, baseFullClassName);
	...
	static function createGetByMethodOne(table:String, vars:List<OrmHaxeVar>, modelFullClassName:String, whereVars:List<OrmHaxeVar>, model:HaxeClass) : Void
	{
	...
	static function createGetByMethodMany(table:String, vars:List<OrmHaxeVar>, modelFullClassName:String, whereVars:Iterable<OrmHaxeVar>, model:HaxeClass) : Void
	{
    ...
    static function getForeignKeyVars(db:HaqDb, table:String, vars:List<OrmHaxeVar>) : List<OrmHaxeVar>
    {
        var foreignKeys = db.connection.getForeignKeys(table);
