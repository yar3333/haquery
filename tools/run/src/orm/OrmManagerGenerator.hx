...
{
	public static function make(log:Log, project:FlashDevelopProject, db:HaqDb, table:String, modelClassName:String, customManagerClassName:String, autogenManagerClassName:String) : Void
	{
	...
	static function getAutogenManager(db:HaqDb, table:String, vars:List<OrmHaxeVar>, modelClassName:String, autogenManagerClassName:String, baseClassName:String=null) : HaxeClass
	{
