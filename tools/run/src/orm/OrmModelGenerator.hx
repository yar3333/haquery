...
{
	public static function make(log:Log, project:FlashDevelopProject, db:HaqDb, table:String, customModelClassName:String, autogenModelClassName:String, customManagerClassName:String) : Void
	{
